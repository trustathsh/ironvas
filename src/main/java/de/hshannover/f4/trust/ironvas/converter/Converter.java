...
public interface Converter {
    ...
    List<PublishElement> toUpdates(Set<Vulnerability> vulnerabilities);

    List<PublishElement> toDeletes(Set<Vulnerability> vulnerabilities);

    Converter setContext(Context context);
